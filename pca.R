...
# Principal Components Analysis Using R - P2 http://www.youtube.com/watch?v=I5GxNzKLIoU 
        ...
        plot(my.classes,cex=0.8,col="blue",main="Plot of Physics Scores vs. Stat Scores")
        options(digits=3)
        par(mfrow=c(1,1))
        ...
        plot(my.scaled.classes,cex=0.8,col="blue",main="Plot of Physics Scores vs. Stat Scores",sub="Mean Scaled",xlim=c(-30,30))
